...
sourcesIndex["pallet_nomination_pools"] = {"name":"","files":["lib.rs","weights.rs"]};
...
sourcesIndex["sc_network"] = {"name":"","dirs":[{"name":"light_client_requests","files":["handler.rs"]},{"name":"protocol","dirs":[{"name":"notifications","dirs":[{"name":"upgrade","files":["collec.rs","notifications.rs"]}],"files":["behaviour.rs","handler.rs","upgrade.rs"]}],"files":["event.rs","message.rs","notifications.rs"]},{"name":"service","files":["metrics.rs","out_events.rs","signature.rs"]}],"files":["behaviour.rs","bitswap.rs","config.rs","discovery.rs","error.rs","lib.rs","light_client_requests.rs","network_state.rs","peer_info.rs","protocol.rs","request_responses.rs","schema.rs","service.rs","transactions.rs","transport.rs","utils.rs"]};
